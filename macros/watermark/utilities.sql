...
{{ var('watermark_database', target.database) }}.{{ generate_schema_name(custom_schema_name=var('watermark_schema', 'public'), node_obj=node) }}
  {%- else -%}
{{ var('watermark_database', target.database) }}.{{ generate_schema_name(custom_schema_name=var('watermark_schema', 'public'), node_obj=node) }}.{{ var('watermark_table', 'dbt_high_watermark') }}
  {%- endif -%}
{% endmacro %}
